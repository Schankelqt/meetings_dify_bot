...
CONFIRMATION_PHRASES = [
    ...
    "абсолютно", "✅", "угу",
    "правильно", "успешно", "так держать", "ок👍", "отлично",
    "без ошибок", "верно всё", "в точку", "именно так", "да, именно так",
    "👌", "👍", "согласен", "согласна", "верно говоришь", "так и есть",
    "да-да", "ага, верно", "да, всё супер", "всё супер", "супер",
    "хорошо", "отлично всё", "всё чётко", "чётко", "ясно", "да, ясно"
]
