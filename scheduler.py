...
schedule.every().tuesday.at("16:20").do(send_questions)
...
schedule.every().tuesday.at("16:24").do(lambda: send_summary(1))
...
schedule.every().tuesday.at("16:25").do(lambda: send_summary(2))
