...
schedule.every().tuesday.at("23:49").do(send_questions)
...
schedule.every().tuesday.at("23:49").do(lambda: send_summary(1))
...
schedule.every().tuesday.at("23:50").do(lambda: send_summary(2))
