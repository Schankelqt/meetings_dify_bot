...
schedule.every().tuesday.at("16:26").do(send_questions)
...
schedule.every().tuesday.at("16:28").do(lambda: send_summary(1))
...
schedule.every().tuesday.at("16:29").do(lambda: send_summary(2))
