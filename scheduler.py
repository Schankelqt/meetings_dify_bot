...
schedule.every().tuesday.at("17:20").do(send_questions, team_id=1, key="daily_regular")
...
schedule.every().tuesday.at("17:22").do(send_report, team_id=1)
...
# Команда 3 (Weekly)
schedule.every().tuesday.at("17:20").do(send_questions, team_id=3, key="weekly")
schedule.every().tuesday.at("17:22").do(send_report, team_id=3)
