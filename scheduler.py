...
schedule.every().wednesday.at("16:22").do(send_questions)
...
schedule.every().wednesday.at("16:25").do(lambda: send_summary(1))
...
schedule.every().wednesday.at("16:25").do(lambda: send_summary(2))
